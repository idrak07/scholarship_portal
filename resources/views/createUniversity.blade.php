			...
			<div class="col-12 col-sm-6 offset-sm-3 border-1 bg-light pt-3 pb-2">
				<form method="POST">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="universityname" name="universityname" placeholder="XYZ University" required>
				  </div>
				  <div class="form-group">
				    <label for="abcd">User Name</label>
				    <input type="text" class="form-control" id="abcd" name="abcd" placeholder="XU (For XYZ University)" required>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="contact" name="contact" placeholder="+01000000000" required>
				  </div>
