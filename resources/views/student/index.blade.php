	  ...
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content">
	      <div class="modal-body text-center">
	        ...
	        <button class="btn btn-md border-0" onclick="{{ session()->put('feedback','1')}}"> <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-emoji-angry-fill" fill="orange" xmlns="http://www.w3.org/2000/svg">
			...
			<button class="btn btn-md border-0" onclick="{{ session()->put('feedback','2')}}"> <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-emoji-frown-fill" fill="orange" xmlns="http://www.w3.org/2000/svg">
			...
			<button class="btn btn-md border-0" onclick="{{ session()->put('feedback','3')}}"> <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-emoji-smile-fill" fill="orange" xmlns="http://www.w3.org/2000/svg">
			...
			<button class="btn btn-md border-0" onclick="{{ session()->put('feedback','4')}}"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-emoji-laughing-fill" fill="orange" xmlns="http://www.w3.org/2000/svg">
			...
			<button class="btn btn-md border-0" onclick="{{ session()->put('feedback','5')}}"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-emoji-heart-eyes-fill" fill="orange" xmlns="http://www.w3.org/2000/svg">
		...
		<div class="row row-content mb-5">
			...
			<div class="col-12 col-sm-4 mt-5" >
				<div class="card" style="width: 18rem;" id="scholarshipCard">
				    <a href="/student/scholarships/{{$data->scholarshipid}}" style=" text-decoration: none; color: inherit;">
					  	<div class="card-body">
						    ...
						    <br>
						    <a href="/student/scholarships/{{$data->scholarshipid}}" class="card-link"><button class="btn" style="background-color: #FCAB08; color: white;">View Scholarship</button></a>
						</div>
					</a>
				</div>
			</div>
