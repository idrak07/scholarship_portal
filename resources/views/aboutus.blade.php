...
<body>
	  ...
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content">
	      <div class="modal-body text-center">
	        ...
	        <button class="btn btn-md border-0" onclick=""> <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-emoji-angry-fill" fill="orange" xmlns="http://www.w3.org/2000/svg">
			...
			<button class="btn btn-md border-0" onclick=""> <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-emoji-frown-fill" fill="orange" xmlns="http://www.w3.org/2000/svg">
			...
			<button class="btn btn-md border-0" onclick=""> <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-emoji-smile-fill" fill="orange" xmlns="http://www.w3.org/2000/svg">
			...
			<button class="btn btn-md border-0" onclick=""><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-emoji-laughing-fill" fill="orange" xmlns="http://www.w3.org/2000/svg">
			...
			<button class="btn btn-md border-0" onclick=""><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-emoji-heart-eyes-fill" fill="orange" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="jumbotron jumbotron-fluid text-center m-2" id="homeJumbotron">
	    <form class="form-inline justify-content-center content" method="post">
	    	{{csrf_field()}}
